  ...
  return (
    <header className="z-[999] relative">
      ...
      <nav className="flex fixed top-[0.15rem] h-12 left-1/2 -translate-x-1/2 py-2 sm:top-[1.7rem] sm:h-[initial] sm:py-0">
        <ul className="flex gap-4 w-[22rem] flex-wrap items-center justify-center gap-y-1 text-[0.9rem] font-medium text-zinc-700 sm:w-[initial] sm:flex-nowrap sm:gap-5 dark:text-zinc-800">
          {links.map((link) => (
            <motion.li
